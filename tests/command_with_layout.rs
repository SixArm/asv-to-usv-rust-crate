...
fn command_with_layout_1() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_FILES_STYLE_SYMBOLS_LAYOUT_1);
}
...
fn command_with_layout_2() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_FILES_STYLE_SYMBOLS_LAYOUT_2);
}
...
fn command_with_layout_units() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_FILES_STYLE_SYMBOLS_LAYOUT_UNITS);
}
...
fn command_with_layout_groups() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_FILES_STYLE_SYMBOLS_LAYOUT_GROUPS);
}
