...
fn command_with_layout_0() {
    ...
    let actual = command_io_str_to_string(command.arg("--layout-0"), EXAMPLE_ASV_FILES);
...
fn command_with_layout_1() {
    let mut command = Command::new(&*COMMAND_OS);
    let actual = command_io_str_to_string(command.arg("--layout-1"), EXAMPLE_ASV_FILES);
...
fn command_with_layout_2() {
    let mut command = Command::new(&*COMMAND_OS);
    let actual = command_io_str_to_string(command.arg("--layout-2"), EXAMPLE_ASV_FILES);
...
fn command_with_layout_units() {
    let mut command = Command::new(&*COMMAND_OS);
    let actual = command_io_str_to_string(command.arg("--layout-units"), EXAMPLE_ASV_FILES);
...
fn command_with_layout_records() {
    let mut command = Command::new(&*COMMAND_OS);
    let actual = command_io_str_to_string(command.arg("--layout-records"), EXAMPLE_ASV_FILES);
...
fn command_with_layout_groups() {
    let mut command = Command::new(&*COMMAND_OS);
    let actual = command_io_str_to_string(command.arg("--layout-groups"), EXAMPLE_ASV_FILES);
